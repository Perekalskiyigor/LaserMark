...
if __name__ == '__main__': 
    ...
    ttk.Label(frame1, text="Введите номер заказа:", font=font_settings).pack(anchor="w")
    entry_order_plm = ttk.Entry(frame1, font=font_settings, width=20)
    entry_order_plm.pack(anchor="w", pady=5)
    ...
    button_select_template_plm.pack(anchor="w", pady=10)

    # Лайбел шаблон выбран
    template_label_plm = tk.Label(frame2, text="Шаблон не выбран", font=font_settings, foreground="red")
    template_label_plm.pack(anchor="w")
    ...
    button_load_template_plm.pack(anchor="w", pady=10)

    load_status_label_plm = tk.Label(frame2, text="Шаблон не загружен", font=font_settings, foreground="red")
    load_status_label_plm.pack(anchor="w")


    entry_numbering_plm = tk.Entry(frame2, font=font_settings, width=20)
    entry_numbering_plm.insert(0, "1")
    entry_numbering_plm.pack(anchor="w", pady=5)

...
# pyinstaller --onefile --add-data "C:\\MaxiGraf\\x64\\APIAndrey\\Acam.dll;." program4.py
    ...
    for i in range(1, count):  
        ...
        if i % 2 != 0:  #  Если четная итерация надо сдвинуть стол на 100 Movemant_left.DistanceL
            ...
            while "MarkingCompletedSuccessfully" not in message1:
                ...
                status_label.config(text=f"Статус:\nОжидаем завершения гравировки...", fg="green")
                time.sleep(1)
...
if __name__ == '__main__': 
    ...
    tab_control.add(tab_plm, text="Главная")  # Добавлена вкладка для ПЛМ
    tab_control.add(tab_main, text="Лицевые панели")
